...
@register_model_architecture('gru', 'gru_wiseman_iwslt_de_en')
def gru_wiseman_iwslt_de_en(args):
    args.dropout = getattr(args, 'dropout', 0.1)
...
@register_model_architecture('gru', 'gru_luong_wmt_en_de')
def gru_luong_wmt_en_de(args):
