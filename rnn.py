...
@register_model_architecture('rnn', 'rnn_wiseman_iwslt_de_en')
def rnn_wiseman_iwslt_de_en(args):
    args.dropout = getattr(args, 'dropout', 0.1)
...
@register_model_architecture('rnn', 'rnn_luong_wmt_en_de')
def rnn_luong_wmt_en_de(args):
